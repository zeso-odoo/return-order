...
publicWidget.registry.SaleOrderPortalReorderWidgetr = publicWidget.Widget.extend({
    selector: ".o_portal_sidebar",
    events: {
        "click .o_wsale_return_order_button": "_onReorder",
    },
    _onReorder(ev) {
        console.log("Custom...............")
        ...
        // Open the modal
        const dialogWrapper = new ComponentWrapper(this, ReturnorderDialogWrapper, {
            orderId: orderId,
...
export class ReturnorderDialogWrapper extends Component {
    setup() {
        this.dialogService = useService("dialog");

        onRendered(() => {
            this.dialogService.add(ReturnorderDialog, this.props);
        });
    }
}
ReturnorderDialogWrapper.template = xml``;

export class ReturnorderConfirmationDialog extends ConfirmationDialog {}
ReturnorderConfirmationDialog.template = "website_sale.ReturnorderConfirmationDialog";
...
ReturnorderDialog.props = {
    close: Function,
    orderId: Number,
    accessToken: String,
};
ReturnorderDialog.components = {
    Dialog,
};
ReturnorderDialog.template = "website_sale.ReturnorderModal";
